...
<?php
	...
	$id_marca_producto=$row['id_peso'];
	if (!empty($id_marca_producto))
	{
	$sql_marca=mysqli_query($con, "select unidad_Peso from unidadpeso where id_peso='$id_marca_producto'");
	$rw_marca=mysqli_fetch_array($sql_marca);
	$nombre_marca=$rw_marca['unidad_Peso'];
