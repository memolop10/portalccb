...
<div class="register-box">
  ...
  <div class="register-logo">
    ...
    <a href="https://empleosccb.com.mx/"><b>empleos</b>CCB</a>
  ...
  <div class="register-box-body">
    ...
    <form action="../../process/reguser.php" method="post">

      <div class="form-group has-feedback">

        <input name="user-name" type="text" class="form-control" placeholder="Nombre Completo">
      ...
      <div class="form-group has-feedback">
        ...
        <input name="user-email" type="email" class="form-control" placeholder="Correo Electrónico">
      ...
      <div class="form-group has-feedback">
        ...
        <input name="user-pass" type="password" class="form-control" placeholder="Contraseña">
