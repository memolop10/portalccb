...
echo '
  ...
  <!-- /.login-box-body -->
	...
	echo "<meta http-equiv=\"refresh\" content=\"0;URL=https://empleosccb.com.mx/\">";
                ...
                <span class="hidden-xs">únete</span>
              </a></li>
			  <li class="dropdown user user-menu">
              <!-- Menu Toggle Button -->
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <ul class="dropdown-menu">
                <!-- The user image in the menu -->
                 ...
                 <img src="https://empleosccb.com.mx/dist/img/photo1.png" class="img-circle" alt="User Image">
  ...
  <div class="login-box-body">
    ...
    <form action="https://empleosccb.com.mx/process/login.php" method="post" role="form"  class="" data-form="login">
