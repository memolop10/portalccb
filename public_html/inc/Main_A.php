    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="https://empleosccb.com.mx" class="navbar-brand"><b>Empleos</b>CCB</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="https://empleosccb.com.mx">Candidato </a></li>
            <li><a href="https://empleosccb.com.mx/Empresas/">Empresa</a></li>
        ...
        <div class="navbar-custom-menu">
          ...
          <div class="login-box-body">
            ...
            <form action="https://empleosccb.com.mx/process/logoutE.php" method="post" role="form"  class="" data-form="login">
  ...
  <!-- /.login-box-body -->
			  ...
			  ';
                    ...
                    echo '
                       ...
                       <li title="Registro de Candidatos"><a href="Candidatos/Registro/">
                <i class="fa fa-black-tie"></i>
                <span class="hidden-xs">Registrate</span>
              </a></li>
            <!-- User Account Menu -->
            <li class="dropdown user user-menu">
              <!-- Menu Toggle Button -->
  ...
  <div class="login-box-body">
    ...
    <form action="process/login.php" method="post" role="form"  class="" data-form="login">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Email" name="email-login">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Contrase&ntilde;a" name="clave-login" >
